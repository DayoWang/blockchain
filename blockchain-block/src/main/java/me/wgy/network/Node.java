...
public class Node {
   ...
   */
  public <T extends MessageData> List<PeerMessage> connectAndSend(PeerInfo peerInfo,
      MessageTypEnum msgType,
      T msgData, boolean waitReply) {
  ...
  /**
   * Starts the loop which is the primary operation of the Node. The main loop opens a server
   * socket, listens for incoming connections, and dispatches them to registered handlers
   * appropriately.
   */
