...
import me.wgy.network.Node;
import me.wgy.network.PeerConnection;
import me.wgy.network.StabilizerInterface;
...
/**
 * A simple stabilization routine that simply sends "PING" messages to every peer in a node's list
 * of peers, and removes from the list any that fail to accept the connection. Whether peers
 * <i>reply</i> to the actual message or not does not matter to this stabilizer.
 *
