...
import me.wgy.network.RouterInterface;

/**
 * A simple router that attempts to route messages by simply looking for the destination peer
 * information in the node's list of peers. If the destination node is not an immediate neighbor,
 * this function fails.
 *
